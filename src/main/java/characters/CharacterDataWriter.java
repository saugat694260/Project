...
public class CharacterDataWriter {
  ...
  public static void writeCharacterToJsonFile(int id) {
    try {
      String fileLocation = FileFolderManager.getCharacterData().getAbsolutePath().toString();
      ...
      if (character != null) {
        ...
        String directoryPath = FileFolderManager.getDirCurrentCharacterData().getAbsolutePath().toString();
